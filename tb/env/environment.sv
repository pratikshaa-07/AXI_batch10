class environment extends uvm_env;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    pas_agt = passive_agent::type_id::create("pas_agt", this);
    scb     = scoreboard::type_id::create("scb", this);
    //sub=subscriber::type_id::create("sub",this);
  endfunction

  virtual function void connect_phase(uvm_phase phase);
    act_agt.mon.send_port.connect(scb.wrt_fifo.analysis_export);
    //act_agt.monitor.mon_port.connect(sub.cov_port.analysis_export);

    pas_agt.mon.send_port.connect(scb.rd_fifo.analysis_export);
